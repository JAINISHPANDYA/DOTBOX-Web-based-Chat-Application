import {
  ...
  const AudioMessageModal = ({ children, setFetchAgain, fetchAgain}) => {
    const OverlayOne = () => (
      <ModalOverlay
        bg="blackAlpha.300"
    ...
    const [fileName, setFileName] = useState(" please select any song");
    ...
    const fileRemove = () => {
      setFile(undefined)
      setUrl("")
      setFileName("please select any song")
    };
        ...
        <>
          ...
          <Modal isCentered isOpen={isOpen} onClose={onClose}>
            ...
            >
              ...
              />
              <ModalHeader color="white">upload Audio</ModalHeader>
              <>
                <Box
                  ref={wrapperRef}
                ...
                >
                  ...
                  <input type="file" accept="audio/*" value="" onChange={onFileDrop} />
                </Box>
                <Box w="90%" mx="auto">
                    <div className="drop-file-preview">
                      ...
                      <Box h="320px" overflow="hidden" m="auto">
                          <Box h="50px" w="380px" mx="auto" my="auto" mt="100px" bg="#f1f3f4" borderRadius="50px" overflow="hidden" p="10px" px="20px" mb="5px">
                        <Text color="black" m="auto">{fileName}</Text>
                          </Box>
