...
const VideoMessageModal = ({ children, setFetchAgain, fetchAgain }) => {
  const OverlayOne = () => (
    <ModalOverlay
      bg="blackAlpha.300"
      ...
      <>
        ...
        <Modal isCentered isOpen={isOpen} onClose={onClose}>
          ...
          >
            ...
            />
            <ModalHeader color="white">upload Video</ModalHeader>
            <>
              <Box
                ref={wrapperRef}
              ...
              >
                ...
                <input type="file" accept="video/*" value="" onChange={onFileDrop} />
              </Box>
              <Box w="90%" mx="auto">
